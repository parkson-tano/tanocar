...
class MyTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def get_token(cls, user):
        ...
        token['individual'] = user.individual
        return token
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'password', 'email', 'phone_number',
                  'first_name', 'last_name', 'corporate', 'individual', 
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('password', 'email', 'first_name',
                  'last_name', 'phone_number', 'corporate', 'individual', 
                  'account_type',)
        extra_kwargs = {
    ...
    def create(self, validated_data):
        user = User.objects.create(
            ...
            individual = validated_data['individual'],
